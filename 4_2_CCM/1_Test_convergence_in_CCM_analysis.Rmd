...
for (i in 1:45) {
  ...
  write.csv(res_list1[[1]], paste("./CCM/ProcessedData/ccm_res_", xmap.name, ".csv", sep=""), row.names=FALSE)
  ...
  write.csv(res_list2[[1]], paste("./CCM/ProcessedData/ccm_res_", xmap.name, ".csv", sep=""), row.names=FALSE)
...
write.csv(maxrho_mat, "./CCM/ccm_tables/maxrho_mat.csv")
write.csv(conv_mat, "./CCM/ccm_tables/conv_mat.csv")
```