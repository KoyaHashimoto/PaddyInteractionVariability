...
for (i in Trt_Cont) {
  ...
  write.csv(ISDD_LRT_res, paste("./output/table/ISDD_LRT_", i, ".csv", sep=""))
}
...
fig5
#ggsave("fig4.ggplot2.pdf", width=14, height=9, device=cairo_pdf, unit="in")
```
...
#ggsave("figS4.ggplot2.pdf", width=9, height=4, device=cairo_pdf, unit="in")
```
